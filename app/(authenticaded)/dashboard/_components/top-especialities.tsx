      ...
      <CardContent>
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <CardTitle className="text-lg text-gray-800">Especialidades</CardTitle>
          </div>
          <Link href="/appointments" className="text-xs font-medium text-gray-500 hover:underline">
            Ver todos
          </Link>
        </div>
              ...
              >
                ...
                <div className="flex w-full flex-col gap-1">
                  <div className="flex w-full justify-between items-center">
                    <h3 className="text-sm font-medium text-gray-700">{specialty.specialty}</h3>
                    <span className="text-xs font-medium text-gray-500">
                      {specialty.appointments} agend.
                    </span>
                  </div>
                  <Progress value={progressValue} className="h-1.5 w-full bg-gray-100 [&>div]:bg-blue-600" />
                </div>
              </div>
            );
          })}
